...
/** @typedef {'list-issues'|'update-status'|'edit-text'|'update-priority'|'create-issue'|'list-ready'|'dep-add'|'dep-remove'|'epic-status'|'update-assignee'|'label-add'|'label-remove'|'subscribe-list'|'unsubscribe-list'|'snapshot'|'upsert'|'delete'|'get-comments'|'add-comment'|'delete-issue'|'list-workspaces'|'set-workspace'|'get-workspace'|'workspace-changed'|'get-statuses'} MessageType */
...
export const MESSAGE_TYPES = /** @type {const} */ ([
  ...
  'get-workspace',
  'workspace-changed',
  // Board: dynamic swimlanes from bd status configuration
  'get-statuses'
]);
